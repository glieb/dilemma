...
bias_dict["ambition"] = (default_range, factor_ambition)
bias_dict["caution"] = (default_range, factor_caution)
bias_dict["ctr_ambition"] = (default_range, factor_ctr_ambition)
bias_dict["ctr_caution"] = (default_range, factor_ctr_ambition)
